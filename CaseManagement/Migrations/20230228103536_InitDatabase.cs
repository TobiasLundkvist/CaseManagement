            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ErrorReportId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ErrorReportDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ErrorReportDueDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ErrorReportDescription = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    ErrorReportStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    MemberId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ErrorReports_Members_MemberId",
                        column: x => x.MemberId,
