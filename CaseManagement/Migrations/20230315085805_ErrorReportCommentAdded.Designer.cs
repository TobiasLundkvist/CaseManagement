...
namespace CaseManagement.Migrations
{
    ...
    [Migration("20230315085805_ErrorReportCommentAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaseManagement.Models.Entities.ErrorReportCommentEntity", b =>
                {
                    b.Property<int>("ErrorReportCommentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ErrorReportCommentId"));

                    b.Property<string>("ErrorReportComment")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.Property<DateTime>("ErrorReportCommentDate")
                        .HasColumnType("datetime2");

                    b.Property<int>("ErrorReportId")
                        .HasColumnType("int");

                    b.HasKey("ErrorReportCommentId");

                    b.HasIndex("ErrorReportId");

                    b.ToTable("ErrorReportsComments");
                });
            ...
            modelBuilder.Entity("CaseManagement.Models.Entities.ErrorReportCommentEntity", b =>
                {
                    b.HasOne("CaseManagement.Models.Entities.ErrorReportEntity", "ErrorReport")
                        .WithMany()
